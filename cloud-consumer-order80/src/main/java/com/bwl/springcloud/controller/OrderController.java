...
import com.bwl.springcloud.common.ResultCode;
import com.bwl.springcloud.entity.Payment;
import com.bwl.springcloud.lb.LoadBalancer;
...
//    public static final String PAYMENT_URL = "http://localhost:8001";
    ...
    public static final String PAYMENT_URL = "http://CLOUD-PAYMANT-SERVICE";
    ...
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id) {
        ...
        if (entity.getStatusCode().is2xxSuccessful()) {
            ...
            return new CommonResult(ResultCode.FAILED.getCode(), ResultCode.FORBIDDEN.getMessage());
        }
    }
